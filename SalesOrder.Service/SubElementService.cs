...
{
    Task<PaginatedList<SubElementDto>> GetSubElements(PaginationQuery queryParams);
...
public class SubElementService : ISubElementService
{
    ...
    public async Task<PaginatedList<SubElementDto>> GetSubElements(PaginationQuery queryParams)
    {
