...
namespace SalesOrder.API.Helpers
{
    ...
    {
        public static ApiPaginatedResponse<TResult> ToApiResponse<TResult>(this PaginatedList<TResult> result, string message = null)
        {
        ...
        public static ApiResponse<Dictionary<string, string>> ToValidationErrorResponse(this ValidationException ex)
        {
            ...
            {
                errorMessagesMap.Add(error.PropertyName, error.ErrorMessage);
            });
